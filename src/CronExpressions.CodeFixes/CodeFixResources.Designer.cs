...
namespace Analyzer1 {
    ...
    internal class CodeFixResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Convert to Cron expression (with seconds).
        /// </summary>
        internal static string CodeFixWithSecondsTitle {
            get {
                return ResourceManager.GetString("CodeFixWithSecondsTitle", resourceCulture);
            }
        }
    }
}
